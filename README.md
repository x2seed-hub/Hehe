local NoNameHUB = library:CreateWindow({
    Name = "NoName HUB" 
})

local MainTab = NoNameHUB:CreateTab({
    Name = "Main"
})
...
MiscSection:AddToggle({
    Name = "Auto Frame Level",   -- ชื่อปุ่ม
    Flag = "AutoFrameLevelToggle",   -- ชื่อตัวแปรสำหรับการเก็บสถานะ (true/false)
...
MiscSection:AddToggle({
    Name = "Farm Bone",   -- ชื่อปุ่ม
    Flag = "FarmBoneToggle",   -- ชื่อตัวแปรสำหรับการเก็บสถานะ (true/false)
    Callback = function(state)
        if state then
            		_G.Auto_Bone = true
...
MiscSection:AddToggle({
    Name = "Farm Fast",   -- ชื่อปุ่ม
    Flag = "FarmFastToggle",   -- ชื่อตัวแปรสำหรับการเก็บสถานะ (true/false)
    Callback = function(state)
        if state then
